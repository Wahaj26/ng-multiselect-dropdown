    ...
    describe('Single Selection', () => {
      ...
      [disabled]="disabled">
        ...
        it('should update internal model on select an item', fakeAsync(() => {
            ...
            expect(fixture.componentInstance.selectedItem).toBeDefined();
            let selItem = fixture.componentInstance.cities[index];
            expect(fixture.componentInstance.selectedItem).toEqual(
                jasmine.objectContaining(selItem)
            );
        ...
        it('selected item should be correct', fakeAsync(() => {
            ...
            expect(fixture.componentInstance.selectedItem).toEqual(selItem);
        }));
        ...
        it('should not select disabled item', fakeAsync(() => {
            ...
            tickAndDetectChanges(fixture);
            expect(
                fixture.componentInstance.select.isDropdownOpen
            ).toBeTruthy();
            expect(fixture.componentInstance.selectedItem).toEqual(
                selectedItems
            ); // selected items must've not changed
        }));
    });
